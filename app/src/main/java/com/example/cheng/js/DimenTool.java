...
//            System.out.println(sw1024);
    ...
    public static void main(String[] args) {
        String startFont = "<dimen name=\"font_size_",
                startWidget = "<dimen name=\"widget_size_",
                center = "\">",
                endFont = "sp</dimen>",
                endWidget = "dp</dimen>";
        StringBuffer stringBuffer = new StringBuffer(startFont);
        StringBuffer sb = new StringBuffer(startWidget);
        int i = 1, j = 1;
        while (i <= 500){
            sb.append(i).append(center).append(i).append(endWidget);
            System.out.println(sb.toString());
            sb = new StringBuffer(startWidget);
            i++;
        }
        while (j <= 50){
            stringBuffer.append(j).append(center).append(j).append(endFont);
            System.out.println(stringBuffer.toString());
            stringBuffer =  new StringBuffer(startFont);
            j++;
        }
        gen();
    }
